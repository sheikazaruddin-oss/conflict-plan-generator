...
def compute_conflict_geometry(
    ...
    # ============================================================
    # : POST-CPA CONTINUATION (ADDITION)
    # ============================================================
    ...
    os_end_lat, os_end_lon = meters_to_latlon(os_cpa[0], os_cpa[1], os_post_dx, os_post_dy)
    os_end_alt = os_cpa[2] + os_post_dz
    ...
    tgt_end_lat, tgt_end_lon = meters_to_latlon(tgt_cpa[0], tgt_cpa[1], tgt_post_dx, tgt_post_dy)
    tgt_end_alt = tgt_cpa[2] + tgt_post_dz
